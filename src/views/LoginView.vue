<template>
    <div class="modal-fondo">
      ...
      <div class="modal-contenido">
        <div class="formulario-registro ">        <h2 class="titulo-paso">Inicio de sesión</h2>
           
           <div class="container-cita">  <div  class="cita">
       <div class="a-box">
         ...
         <div class="campo-formulario">
           <label>Usuario:</label>
           <input v-model="usuario.correo" type="email" placeholder="Ejemplo@correo.com">
           </div>
         <div class="campo-formulario">
           <label>Contraseña:</label>
           <input v-model="usuario.contrasenia" type="password" placeholder="*********">
         </div>
       
         <div class="acciones-formulario">
            <button @click="afiliarte()" class="boton boton-primario">Solicitar afiliarte</button>
            <button @click="iniciarSesion()" class="boton boton-secundario">Iniciar sesión</button>
            </div>
       </div>
      </div>
    </div>
